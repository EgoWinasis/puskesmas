                        ...
                        <x-adminlte-card class="col-md-12" theme-mode="full">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <x-adminlte-input name="nik" id="nik" oninput="removeNonNumeric(this)" value="{{old('nik')}}">
                                    </x-adminlte-input>
                                </div>
                                <div class="col-md-6">
                                    <label for="bpjs">BPJS</label>
                                    <x-adminlte-input name="bpjs" id="bpjs" oninput="removeNonNumeric(this)" value="{{old('bpjs')}}">
                                    </x-adminlte-input>
                                </div>
                                {{-- Nama --}}
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <x-adminlte-input name="tgl_lahir" id="tgl_lahir" class="inputTgl" value="{{old('tgl_lahir')}}">
                                    </x-adminlte-input>
                                </div>
                              
                                <div class="col-md-6">
                                    <label for="hp">HP</label>
                                    <x-adminlte-input name="hp" id="hp" oninput="removeNonNumeric(this)" value="{{old('hp')}}">
                                    </x-adminlte-input>
                                </div>
                                <div class="col-md-6">
